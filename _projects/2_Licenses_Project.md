...
image: assets/pngs/license_thumb.png
...
<a href="https://raw.githubusercontent.com/UIUC-iSchool-DataViz/is445_data/main/licenses_fall2022.csv" style="color: white; font-weight: bold; text-decoration: none; border: 1px solid white; padding: 5px 10px; border-radius: 5px;">The Data</a> 
&nbsp;
<a href="https://github.com/dhur3/dhur3.github.io/blob/main/python_notebooks/Workbook.ipynb" style="color: white; font-weight: bold; text-decoration: none; border: 1px solid white; padding: 5px 10px; border-radius: 5px;">The Analysis</a>

<br><br>

<vegachart schema-url="/assets/json/licenses_chart_hw5.1.json" style="width: 100%"></vegachart>
